...
Route::group([
    ...
    Route::get('/reports/{report}/sub-report/{subReport:date}', [ReportController::class, 'showSubReport'])->name('reports.sub.show');
    Route::get('/reports/{report}/sub-report/{subReport:date}/edit', [ReportController::class, 'editSubReport'])->name('reports.sub.edit');
