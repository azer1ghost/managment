...
class TaskForm extends Component
{
    ...
    public function mount($task)
    {
        ...
        $this->status = $this->task->getAttribute('status');
        $this->priority = $this->task->getAttribute('priority');
        $this->department = \Str::contains('\Department', $this->task->getAttribute('taskable_type')) ? $this->task->getAttribute('taskable_id') : '';
        $this->user = \Str::contains('\User', $this->task->getAttribute('taskable_type')) ? $this->task->getAttribute('taskable_id') : '';
    }
