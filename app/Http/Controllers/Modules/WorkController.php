...
//                            $work->parameters()->updateExistingPivot($work::ILLEGALAMOUNT, ['value' => $work->getParameter($work::GB) * 15]);
                ...
                if (in_array($request->get('asan_imza_id'), [29, 34, 36, 39, 40, 30, 32, 33, 41, 43, 39, 46, 47, 49, 50, 48, 22, 53, 54, 55, 56, 57, 63, 80, 60, 71, 74, 83, 61, 73, 64, 72, 82, 100, 102,  98, 95, 94, 93, 91, 90, 87, 83, 78, 127, 128, 129, 130])) {
