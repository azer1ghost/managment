...
//                            $work->parameters()->updateExistingPivot($work::ILLEGALAMOUNT, ['value' => $work->getParameter($work::GB) * 15]);
    ...
    public function showTotal(Request $request)
    {
        ...
        $CompanyCategories = [
            'ASAZA' => [39, 55, 80, 77, 83, 90],
            'GARANT' => [8, 9, 10, 25, 27, 45, 52, 59, 16, 62, 7, 11, 12, 14, 16, 21, 24, 124, 115, 112, 108, 101, 97, 89, 81, 75, 52],
            'RIGEL' => [30, 32, 41, 43, 54, 74, 100, 110, 117, 125],
            'MIND' => [29, 36, 53, 60, 63, 71, 93, 102, 113],
            'TEDORA' => [48, 57, 72, 82, 91, 104, 126],
            'DECLARE' => [47, 50, 56, 61],
            'MOBIL' => [3, 51, 44, 38, 35, 31, 28, 26, 19, 5, 4, 58, 23, 2, 20, 18, 17, 6, 56, 73, 98, 107, 114],
        ];
