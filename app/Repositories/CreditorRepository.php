...
//            ->when($filters['company'], fn($query) => $query->where('company_id', fn($q) => $q->where('id', $filters['company'])))
//            ->when($filters['supplier'], fn($query) => $query->where('supplier_id', fn($q) => $q->where('id', $filters['supplier'])));
