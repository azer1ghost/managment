...
return [
    ...
    */
    ...
    'permissions' => [
        ...
        'viewAny-salesInquiry', 'viewAll-salesInquiry', 'checkRejectedReason-inquiry',
        ...
        'workPersonal-widget',
        'service-widget',
        'viewAll-work', 'viewAny-work', 'view-work', 'create-work', 'update-work', 'delete-work', 'canVerify-work', 'canRedirect-work', 'viewAllDepartment-work', 'satisfactionMeasure-work', 'viewPrice-work',
    ],
