...
return [
    ...
    */
    ...
    'permissions' => [
        ...
        'workPersonal-widget',
        'service-widget',
        'viewAll-work', 'viewAny-work', 'view-work', 'create-work', 'update-work', 'delete-work', 'canVerify-work', 'canRedirect-work', 'viewAllDepartment-work', 'satisfactionMeasure-work',
    ],
