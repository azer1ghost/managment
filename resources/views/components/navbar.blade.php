<div class="navbar-menu-wrapper d-flex align-items-center justify-content-end" x-data>
    ...
    <ul class="navbar-nav navbar-nav-right">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list p-2" style="min-width: 400px;max-width: 100%;height: 400px;overflow-x: hidden">  <!--  -->
                    ...
                    <template x-for="(notification, index) in $store.state.notifications" :key="index">
                        <a x-bind:href="notification.url" class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content">
                                ...
                                <p x-text="notification.message" class="mb-1" style="font-size: 12px; width: 100px; overflow-wrap: break-word !important;"></p>
