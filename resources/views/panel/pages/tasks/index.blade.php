                ...
                <table class="table table-responsive-sm table-hover">
                    ...
                    @forelse($tasks as $task)
                        ...
                        >
                            ...
                            <td style="font-weight: 700;max-width: 100%;white-space: nowrap;" class="task-priority {{$task->getAttribute('priority')}}">@if($task->getAttribute('priority') == 'urgent') <i class="fas fa-exclamation-circle"></i> @endif @lang('translates.fields.priority.options.' . $task->getAttribute('priority'))</td>
