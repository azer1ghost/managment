                ...
                <table class="table table-responsive-sm table-hover">
                    ...
                    @endforelse
                        <tr style="background: #b3b7bb">
                            <td colspan="@if(auth()->user()->isDeveloper() && $hasPending) 9 @elseif(auth()->user()->isDeveloper()) 8 @elseif(auth()->user()->hasPermission('viewAll-work')) 8 @elseif(auth()->user()->hasPermission('canVerify-work') && $hasPending) 7 @else 7 @endif">
