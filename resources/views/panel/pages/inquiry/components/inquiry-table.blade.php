...
<div>
    <form id="inquiryFilterForm" class="row">
        ...
        <div class="form-group col-12 col-md-3 mt-2 mb-3 mb-md-0">
            <label for="clientNamePhoneFilter">@lang('translates.filters.or', ['first' => __('translates.fields.client'), 'second' => __('translates.fields.phone')])</label>
            <input type="search" id="clientNamePhoneFilter" placeholder="@lang('translates.placeholders.or', ['first' => __('translates.fields.client'), 'second' => __('translates.fields.phone')])" class="form-control" wire:model.defer="parameterFilters.client_name_phone">
        </div>
    </form>
