...
@section('content')
    ...
    <div class="row">
        <div class="col-8" style="border-right: black solid 2px">
            <div id="app">
...
@section('scripts')
    ...
    <script>
        ...
        getNotes().forEach((note) => {
            const noteElement = createNoteElement(note.id, note.content, note.user_id);
        ...
        function createNoteElement(id, content, user_id) {
            ...
            element.addEventListener("change", () => {
                updateNote(id, element.value, user_id);
            });
