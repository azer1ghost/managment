...
{{--                    <td></td>--}}
        ...
        @if($works->isNotEmpty())
            <tr style="background: #b3b7bb" id="count">
                <td colspan="@if(auth()->user()->isDeveloper() || auth()->user()->hasPermission('satisfactionMeasure-work')) 10 @elseif(auth()->user()->hasPermission('viewAll-work') || auth()->user()->hasPermission('canVerify-work')) 7 @else 6 @endif">
