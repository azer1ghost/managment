                    ...
                    <div>
                        <div>
                            <div class="px-lg-5 my-5">
                                <div class="text-center my-5"><h4>@lang('translates.customer_satisfaction.rate')</h4>
                                </div>
                                <input type="hidden" id="rate-input" value="{{optional($data)->getAttribute('rate')}}"
                                       name="rate" wire:ignore>
                        ...
                        <div class="row px-lg-5">
                            ...
                            @endforeach
                            <div class="form-group col-12 text-center" wire:ignore>
                                <label style="font-weight: 20; display: block"
                                       for="data-note">@lang('translates.customer_satisfaction.note')</label>
                                <textarea style="border: 1px solid black;" class="form-control" name="note"
                                          id="data-note" placeholder="@lang('translates.placeholders.comment')"
                                          cols="30" rows="10">{{optional($data)->getAttribute('note')}}</textarea>
                            </div>
                        </div>
                    </div>
