...
@section('content')
    ...
    <div class="row mb-2">
        <div class="col-12 justify-content-center">
            <h2 data-toggle="collapse" href="#task">MB-TL-M002 Tapşırıqlar</h2>
            ...
            @if(auth()->user()->isDirector() || auth()->user()->hasPermission('update-user'))
                <h2 data-toggle="collapse" href="#hr">MB-TL-M003 HR</h2>
            ...
            <h2 data-toggle="collapse" href="#calendar">MB-TL-M004 Təqvim</h2>
            <div class="collapse" id="calendar">
                <video class="mr-5" width="100%" controls><source src="{{asset('videos/teqvim.mp4')}}" type="video/mp4"></video>
            </div>

            <h2 data-toggle="collapse" href="#work">MB-TL-M005 İşlər</h2>
            ...
            @if(auth()->user()->isDirector() || auth()->user()->hasPermission('editTable-work'))
                <h2 data-toggle="collapse" href="#declaration">MB-TL-B001 Qısa idxal bəyannaməsi</h2>
