    ...
    <div class="row mb-2">
        <div class="col-12 justify-content-center">
            ...
            <div class="collapse" id="inquiry">
                ...
                <video class="mr-5" width="100%" controls><source src="{{asset('videos/satis.mkv')}}" type="video/mp4"></video>
            ...
            @if(auth()->user()->isDirector() || auth()->user()->hasPermission('update-work'))
                ...
                <div class="collapse" id="declaration">
                    ...
                    <video class="mr-5" width="100%" controls><source src="{{asset('videos/hnbgisd.mp4')}}" type="video/mp4"></video>
                </div>
            @endif
        </div>
    </div>
